...
// ==============================================================
#ifndef __crypto_sign_keypakbM__HH__
#define __crypto_sign_keypakbM__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(crypto_sign_keypakbM) {
    ...
    SC_CTOR(crypto_sign_keypakbM):  simcore_mac_0_U ("simcore_mac_0_U") {
