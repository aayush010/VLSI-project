...
// ==============================================================
#ifndef __crypto_sign_keypalbW__HH__
#define __crypto_sign_keypalbW__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(crypto_sign_keypalbW) {
    ...
    SC_CTOR(crypto_sign_keypalbW):  simcore_mac_1_U ("simcore_mac_1_U") {
