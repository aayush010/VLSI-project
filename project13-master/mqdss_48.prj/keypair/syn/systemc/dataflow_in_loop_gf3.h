...
#ifndef _dataflow_in_loop_gf3_HH_
#define _dataflow_in_loop_gf3_HH_
...
struct dataflow_in_loop_gf3 : public sc_module {
    ...
    // Module declarations
    dataflow_in_loop_gf3(sc_module_name name);
    SC_HAS_PROCESS(dataflow_in_loop_gf3);

    ~dataflow_in_loop_gf3();
    ...
    sc_signal< sc_lv<6> > Block_entry_proc_pro_U0_out_r_address0;
    sc_signal< sc_logic > Block_entry_proc_pro_U0_out_r_ce0;
    sc_signal< sc_logic > Block_entry_proc_pro_U0_out_r_we0;
    sc_signal< sc_lv<8> > Block_entry_proc_pro_U0_out_r_d0;
