...
entity KeccakF1600_StatefYi_rom is 
    generic(
             DWIDTH     : integer := 64; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 24
...
architecture rtl of KeccakF1600_StatefYi_rom is 
...
entity KeccakF1600_StatefYi is
    generic (
...
architecture arch of KeccakF1600_StatefYi is
    component KeccakF1600_StatefYi_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    KeccakF1600_StatefYi_rom_U :  component KeccakF1600_StatefYi_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
