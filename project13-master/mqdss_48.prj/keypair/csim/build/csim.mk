...
HLS_SOURCES = ../../../../newtest_sign.c ../../../../sign.c ../../../../rng.c ../../../../mq.c ../../../../gf31.c ../../../../fips202.c ../../../../aes.c
...
$(ObjDir)/mq.o: ../../../../mq.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../mq.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/mq.d

$(ObjDir)/gf31.o: ../../../../gf31.c $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../gf31.c in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/gf31.d
