...
// ==============================================================
# 1 "C:/Users/ajaiswal/Downloads/project13-master/gf31.c"
# 1 "C:/Users/ajaiswal/Downloads/project13-master/gf31.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/ajaiswal/Downloads/project13-master/gf31.c" 2
...
# 2 "C:/Users/ajaiswal/Downloads/project13-master/gf31.c" 2
...
# 3 "C:/Users/ajaiswal/Downloads/project13-master/gf31.c" 2
...
# 4 "C:/Users/ajaiswal/Downloads/project13-master/gf31.c" 2
# 1 "C:/Users/ajaiswal/Downloads/project13-master/params.h" 1
# 5 "C:/Users/ajaiswal/Downloads/project13-master/gf31.c" 2
...
# 6 "C:/Users/ajaiswal/Downloads/project13-master/gf31.c" 2
...
# 7 "C:/Users/ajaiswal/Downloads/project13-master/gf31.c" 2
...
void vgf31_unique(gf31 *out, gf31 *in)
{
    ...
    vgf31_unique_label0:for (i = 0; i < 48; i++) {
...
void vgf31_shorten_unique(gf31 *out, gf31 *in)
{
    ...
    vgf31_shorten_unique_label0:for (i = 0; i < 48; i++) {
        out[i] = mod31(in[i]);
    }
}
...
void gf31_nrand(gf31 *out, const int len, const unsigned char *seed, const int seedlen)
{
    ...
    gf31_nrand_label1:while (i < len) {
        shake256_squeezeblocks(shakeblock, 1, shakestate);
        gf31_nrand_label0:for (j = 0; j < 136 && i < len; j++) {
...
void gf31_nrand_schar(signed char *out, const int len, const unsigned char *seed, const int seedlen)
{
    ...
    gf31_nrand_schar_label2:while (i < len) {
        shake256_squeezeblocks(shakeblock, 1, shakestate);
        gf31_nrand_schar_label1:for (j = 0; j < 136 && i < len; j++) {
            if ((shakeblock[j] & 31) != 31) {
...
void gf31_nunpack(gf31 *out, const unsigned char *in, const unsigned int n)
{
    ...
    gf31_nunpack_label2:for (i = n-1; i >= 0; i--) {
        out[i] = (in[j] >> d) & 31;
        d += 5;
        if (d > 8) {
            d -= 8;
...
void gf31_npack(unsigned char *out, const gf31 *in, const unsigned int n)
{
    ...
    for (j = 0; j < n; j++) {
        (void) ((!!(in[j] < 31)) || (_assert("in[j] < 31","C:/Users/ajaiswal/Downloads/project13-master/gf31.c",123),0));
    }



    gf31_npack_label3:for(loop=0;loop<((5 * n + 7) & ~7) >> 3;loop++)
 out[loop]=0;

    gf31_npack_label4:for (j = 0; j < n; j++) {
        if (d < 0) {
            d += 8;
            out[i] = (out[i] & (255 << (d - 3))) |
                      ((in[j] >> (8 - d)) & ~(255 << (d - 3)));
