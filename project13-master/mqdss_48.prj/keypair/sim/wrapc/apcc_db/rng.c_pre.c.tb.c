...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 0, !dbg !14 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_962_count);
  llvm_cbe_tmp__277 = ( char *)(&llvm_cbe_block[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
if (AESL_DEBUG_TRACE) {
  ...
  llvm_cbe_tmp__278__PHI_TEMPORARY = (unsigned int )0u;   /* for PHI node */
...
if (AESL_DEBUG_TRACE)
printf("\n  %%24 = add nsw i32 %%3, 16, !dbg !14 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1009_count);
  llvm_cbe_tmp__291 = (unsigned int )((unsigned int )(llvm_cbe_tmp__278&4294967295ull)) + ((unsigned int )(16u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__291&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%25 = add i64 %%storemerge2411, -16, !dbg !13 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1014_count);
  llvm_cbe_tmp__292 = (unsigned long long )((unsigned long long )(llvm_cbe_storemerge2411&18446744073709551615ull)) + ((unsigned long long )(18446744073709551600ull&18446744073709551615ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", ((unsigned long long )(llvm_cbe_tmp__292&18446744073709551615ull)));
  if (((llvm_cbe_tmp__292&18446744073709551615ULL) == (0ull&18446744073709551615ULL))) {
    goto llvm_cbe__2e__crit_edge;
  } else {
    llvm_cbe_storemerge2411__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__292;   /* for PHI node */
    llvm_cbe_tmp__278__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__291;   /* for PHI node */
    goto llvm_cbe__2e_preheader8;
  }
...
if (AESL_DEBUG_TRACE)
printf("\n  %%17 = sext i32 %%storemerge37 to i64, !dbg !12 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_995_count);
  llvm_cbe_tmp__284 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge37);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__284);
if (AESL_DEBUG_TRACE)
printf("\n  %%18 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 %%17, !dbg !12 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_996_count);
  llvm_cbe_tmp__285 = ( char *)(&llvm_cbe_block[(((signed long long )llvm_cbe_tmp__284))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__284) < 16)) fprintf(stderr, "%s:%d: warning: Read access out of array 'block' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%19 = load i8* %%18, align 1, !dbg !12 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_997_count);
  llvm_cbe_tmp__286 = (unsigned char )*llvm_cbe_tmp__285;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__286);
if (AESL_DEBUG_TRACE)
printf("\n  %%20 = add nsw i32 %%storemerge37, %%3, !dbg !12 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_998_count);
  llvm_cbe_tmp__287 = (unsigned int )((unsigned int )(llvm_cbe_storemerge37&4294967295ull)) + ((unsigned int )(llvm_cbe_tmp__278&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__287&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%21 = sext i32 %%20 to i64, !dbg !12 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_999_count);
  llvm_cbe_tmp__288 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__287);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__288);
if (AESL_DEBUG_TRACE)
printf("\n  %%22 = getelementptr inbounds i8* %%x, i64 %%21, !dbg !12 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1000_count);
  llvm_cbe_tmp__289 = ( char *)(&llvm_cbe_x[(((signed long long )llvm_cbe_tmp__288))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__288));
}
if (AESL_DEBUG_TRACE)
printf("\n  store i8 %%19, i8* %%22, align 1, !dbg !12 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1001_count);
  *llvm_cbe_tmp__289 = llvm_cbe_tmp__286;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__286);
if (AESL_DEBUG_TRACE)
printf("\n  %%23 = add nsw i32 %%storemerge37, 1, !dbg !15 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1002_count);
  llvm_cbe_tmp__290 = (unsigned int )((unsigned int )(llvm_cbe_storemerge37&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__290&4294967295ull)));
  if (((llvm_cbe_tmp__290&4294967295U) == (16u&4294967295U))) {
    goto llvm_cbe__2e_backedge;
  } else {
    llvm_cbe_storemerge37__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__290;   /* for PHI node */
...
if (AESL_DEBUG_TRACE)
printf("\n  call void @AES256_ECB(i8* getelementptr inbounds (%%struct.AES256_CTR_DRBG_struct* @DRBG_ctx, i64 0, i32 0, i64 0), i8* getelementptr inbounds (%%struct.AES256_CTR_DRBG_struct* @DRBG_ctx, i64 0, i32 1, i64 0), i8* %%2), !dbg !14 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_986_count);
  AES256_ECB(( char *)((&DRBG_ctx.field0[(((signed long long )0ull))])), ( char *)((&DRBG_ctx.field1[(((signed long long )0ull))])), ( char *)llvm_cbe_tmp__277);
if (AESL_DEBUG_TRACE) {
}
...
llvm_cbe_tmp__306:
if (AESL_DEBUG_TRACE)
printf("\n  store i8 0, i8* %%8, align 1, !dbg !14 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_979_count);
  *llvm_cbe_tmp__280 = ((unsigned char )0);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned char )0));
if (AESL_DEBUG_TRACE)
printf("\n  %%12 = add nsw i32 %%storemerge, -1, !dbg !15 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_980_count);
  llvm_cbe_tmp__282 = (unsigned int )((unsigned int )(llvm_cbe_storemerge&4294967295ull)) + ((unsigned int )(4294967295u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__282&4294967295ull)));
  llvm_cbe_storemerge__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__282;   /* for PHI node */
  goto llvm_cbe_tmp__304;

llvm_cbe_tmp__305:
if (AESL_DEBUG_TRACE)
printf("\n  %%7 = sext i32 %%storemerge to i64, !dbg !14 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_974_count);
  llvm_cbe_tmp__279 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__279);
if (AESL_DEBUG_TRACE)
printf("\n  %%8 = getelementptr inbounds %%struct.AES256_CTR_DRBG_struct* @DRBG_ctx, i64 0, i32 1, i64 %%7, !dbg !14 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_975_count);
  llvm_cbe_tmp__280 = ( char *)(&DRBG_ctx.field1[(((signed long long )llvm_cbe_tmp__279))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__279));
}
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = load i8* %%8, align 1, !dbg !14 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_976_count);
  llvm_cbe_tmp__281 = (unsigned char )*llvm_cbe_tmp__280;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__281);
  if (((llvm_cbe_tmp__281&255U) == (((unsigned char )-1)&255U))) {
...
llvm_cbe_tmp__307:
if (AESL_DEBUG_TRACE)
printf("\n  %%14 = add i8 %%9, 1, !dbg !15 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_983_count);
  llvm_cbe_tmp__283 = (unsigned char )((unsigned char )(((unsigned char )(llvm_cbe_tmp__281&255ull)) + ((unsigned char )(((unsigned char )1)&255ull))));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned char )(llvm_cbe_tmp__283&255ull)));
if (AESL_DEBUG_TRACE)
printf("\n  store i8 %%14, i8* %%8, align 1, !dbg !15 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_984_count);
  *llvm_cbe_tmp__280 = llvm_cbe_tmp__283;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__283);
  goto llvm_cbe__2e_loopexit9;
...
llvm_cbe__2e_preheader:
  if (((llvm_cbe_storemerge2411&18446744073709551615ULL) == (0ull&18446744073709551615ULL))) {
    ...
    llvm_cbe_tmp__293__PHI_TEMPORARY = (unsigned long long )0ull;   /* for PHI node */
...
if (AESL_DEBUG_TRACE)
printf("\n  %%28 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 %%27, !dbg !12 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1019_count);
  llvm_cbe_tmp__294 = ( char *)(&llvm_cbe_block[(((signed long long )llvm_cbe_tmp__293))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
#ifdef AESL_BC_SIM
  if (!(((signed long long )llvm_cbe_tmp__293) < 16)) fprintf(stderr, "%s:%d: warning: Read access out of array 'block' bound?\n", __FILE__, __LINE__);

#endif
if (AESL_DEBUG_TRACE)
printf("\n  %%29 = load i8* %%28, align 1, !dbg !12 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1020_count);
  llvm_cbe_tmp__295 = (unsigned char )*llvm_cbe_tmp__294;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__295);
if (AESL_DEBUG_TRACE)
printf("\n  %%30 = add nsw i32 %%storemerge15, %%3, !dbg !12 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1021_count);
  llvm_cbe_tmp__296 = (unsigned int )((unsigned int )(llvm_cbe_storemerge15&4294967295ull)) + ((unsigned int )(llvm_cbe_tmp__278&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__296&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%31 = sext i32 %%30 to i64, !dbg !12 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1022_count);
  llvm_cbe_tmp__297 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__296);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__297);
if (AESL_DEBUG_TRACE)
printf("\n  %%32 = getelementptr inbounds i8* %%x, i64 %%31, !dbg !12 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1023_count);
  llvm_cbe_tmp__298 = ( char *)(&llvm_cbe_x[(((signed long long )llvm_cbe_tmp__297))]);
if (AESL_DEBUG_TRACE) {
printf("\n = 0x%I64X",((signed long long )llvm_cbe_tmp__297));
}
if (AESL_DEBUG_TRACE)
printf("\n  store i8 %%29, i8* %%32, align 1, !dbg !12 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1024_count);
  *llvm_cbe_tmp__298 = llvm_cbe_tmp__295;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__295);
if (AESL_DEBUG_TRACE)
printf("\n  %%33 = add nsw i32 %%storemerge15, 1, !dbg !15 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1025_count);
  llvm_cbe_tmp__299 = (unsigned int )((unsigned int )(llvm_cbe_storemerge15&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__299&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  %%34 = sext i32 %%33 to i64, !dbg !13 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1031_count);
  llvm_cbe_tmp__300 = (unsigned long long )((signed long long )(signed int )llvm_cbe_tmp__299);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__300);
  if ((((unsigned long long )llvm_cbe_tmp__300&18446744073709551615ULL) < ((unsigned long long )llvm_cbe_storemerge2411&18446744073709551615ULL))) {
    llvm_cbe_tmp__293__PHI_TEMPORARY = (unsigned long long )llvm_cbe_tmp__300;   /* for PHI node */
    llvm_cbe_storemerge15__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__299;   /* for PHI node */
    goto llvm_cbe__2e_lr_2e_ph;
  } else {
    goto llvm_cbe__2e_backedge_2e_thread;
  }
...
llvm_cbe_tmp__303:
if (AESL_DEBUG_TRACE)
printf("\n  call void @AES256_CTR_DRBG_Update(i8* null, i8* getelementptr inbounds (%%struct.AES256_CTR_DRBG_struct* @DRBG_ctx, i64 0, i32 0, i64 0), i8* getelementptr inbounds (%%struct.AES256_CTR_DRBG_struct* @DRBG_ctx, i64 0, i32 1, i64 0)), !dbg !15 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1035_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%37 = load i32* getelementptr inbounds (%%struct.AES256_CTR_DRBG_struct* @DRBG_ctx, i64 0, i32 2), align 4, !dbg !16 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1036_count);
  llvm_cbe_tmp__301 = (unsigned int )*((&DRBG_ctx.field2));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__301);
if (AESL_DEBUG_TRACE)
printf("\n  %%38 = add nsw i32 %%37, 1, !dbg !16 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1037_count);
  llvm_cbe_tmp__302 = (unsigned int )((unsigned int )(llvm_cbe_tmp__301&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__302&4294967295ull)));
if (AESL_DEBUG_TRACE)
printf("\n  store i32 %%38, i32* getelementptr inbounds (%%struct.AES256_CTR_DRBG_struct* @DRBG_ctx, i64 0, i32 2), align 4, !dbg !16 for 0x%I64xth hint within @randombytes  --> \n", ++aesl_llvm_cbe_1038_count);
  *((&DRBG_ctx.field2)) = llvm_cbe_tmp__302;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__302);
  if (AESL_DEBUG_TRACE)
      printf("\nEND @randombytes}\n");
...
printf("\n  store i8 0, i8* %%5, align 1, !dbg !14 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1062_count);
  *llvm_cbe_tmp__309 = ((unsigned char )0);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned char )0));
if (AESL_DEBUG_TRACE)
printf("\n  %%9 = add nsw i32 %%storemerge, -1, !dbg !14 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1063_count);
  llvm_cbe_tmp__311 = (unsigned int )((unsigned int )(llvm_cbe_storemerge&4294967295ull)) + ((unsigned int )(4294967295u&4294967295ull));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned int )(llvm_cbe_tmp__311&4294967295ull)));
  llvm_cbe_storemerge__PHI_TEMPORARY = (unsigned int )llvm_cbe_tmp__311;   /* for PHI node */
  goto llvm_cbe_tmp__362;

llvm_cbe_tmp__363:
if (AESL_DEBUG_TRACE)
printf("\n  %%4 = sext i32 %%storemerge to i64, !dbg !13 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1057_count);
  llvm_cbe_tmp__308 = (unsigned long long )((signed long long )(signed int )llvm_cbe_storemerge);
if (AESL_DEBUG_TRACE)
printf("\n = 0x%I64X\n", llvm_cbe_tmp__308);
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = getelementptr inbounds %%struct.AES256_CTR_DRBG_struct* @DRBG_ctx, i64 0, i32 1, i64 %%4, !dbg !13 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1058_count);
  llvm_cbe_tmp__309 = ( char *)(&DRBG_ctx.field1[(((signed long long )llvm_cbe_tmp__308))]);
if (AESL_DEBUG_TRACE) {
...
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__310);
  if (((llvm_cbe_tmp__310&255U) == (((unsigned char )-1)&255U))) {
...
printf("\n  %%11 = add i8 %%6, 1, !dbg !14 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1066_count);
  llvm_cbe_tmp__312 = (unsigned char )((unsigned char )(((unsigned char )(llvm_cbe_tmp__310&255ull)) + ((unsigned char )(((unsigned char )1)&255ull))));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", ((unsigned char )(llvm_cbe_tmp__312&255ull)));
if (AESL_DEBUG_TRACE)
printf("\n  store i8 %%11, i8* %%5, align 1, !dbg !14 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1067_count);
  *llvm_cbe_tmp__309 = llvm_cbe_tmp__312;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__312);
  goto llvm_cbe__2e_loopexit;
...
printf("\n  %%12 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 0, !dbg !14 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1069_count);
  llvm_cbe_tmp__313 = ( char *)(&llvm_cbe_block[(((signed long long )0ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  call void @AES256_ECB(i8* getelementptr inbounds (%%struct.AES256_CTR_DRBG_struct* @DRBG_ctx, i64 0, i32 0, i64 0), i8* getelementptr inbounds (%%struct.AES256_CTR_DRBG_struct* @DRBG_ctx, i64 0, i32 1, i64 0), i8* %%12), !dbg !14 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1070_count);
  AES256_ECB(( char *)((&DRBG_ctx.field0[(((signed long long )0ull))])), ( char *)((&DRBG_ctx.field1[(((signed long long )0ull))])), ( char *)llvm_cbe_tmp__313);
if (AESL_DEBUG_TRACE) {
}
...
printf("\n  %%14 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 1, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1083_count);
  llvm_cbe_tmp__315 = ( char *)(&llvm_cbe_block[(((signed long long )1ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%16 = getelementptr inbounds i8* %%x, i64 1, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1085_count);
  llvm_cbe_tmp__317 = ( char *)(&llvm_cbe_x[(((signed long long )1ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%17 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 2, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1092_count);
  llvm_cbe_tmp__318 = ( char *)(&llvm_cbe_block[(((signed long long )2ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%19 = getelementptr inbounds i8* %%x, i64 2, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1094_count);
  llvm_cbe_tmp__320 = ( char *)(&llvm_cbe_x[(((signed long long )2ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%20 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 3, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1101_count);
  llvm_cbe_tmp__321 = ( char *)(&llvm_cbe_block[(((signed long long )3ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%22 = getelementptr inbounds i8* %%x, i64 3, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1103_count);
  llvm_cbe_tmp__323 = ( char *)(&llvm_cbe_x[(((signed long long )3ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%23 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 4, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1110_count);
  llvm_cbe_tmp__324 = ( char *)(&llvm_cbe_block[(((signed long long )4ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%25 = getelementptr inbounds i8* %%x, i64 4, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1112_count);
  llvm_cbe_tmp__326 = ( char *)(&llvm_cbe_x[(((signed long long )4ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%26 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 5, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1119_count);
  llvm_cbe_tmp__327 = ( char *)(&llvm_cbe_block[(((signed long long )5ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%28 = getelementptr inbounds i8* %%x, i64 5, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1121_count);
  llvm_cbe_tmp__329 = ( char *)(&llvm_cbe_x[(((signed long long )5ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%29 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 6, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1128_count);
  llvm_cbe_tmp__330 = ( char *)(&llvm_cbe_block[(((signed long long )6ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%32 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 7, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1137_count);
  llvm_cbe_tmp__333 = ( char *)(&llvm_cbe_block[(((signed long long )7ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%35 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 8, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1146_count);
  llvm_cbe_tmp__336 = ( char *)(&llvm_cbe_block[(((signed long long )8ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%37 = getelementptr inbounds i8* %%x, i64 8, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1148_count);
  llvm_cbe_tmp__338 = ( char *)(&llvm_cbe_x[(((signed long long )8ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%38 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 9, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1155_count);
  llvm_cbe_tmp__339 = ( char *)(&llvm_cbe_block[(((signed long long )9ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%40 = getelementptr inbounds i8* %%x, i64 9, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1157_count);
  llvm_cbe_tmp__341 = ( char *)(&llvm_cbe_x[(((signed long long )9ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%41 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 10, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1164_count);
  llvm_cbe_tmp__342 = ( char *)(&llvm_cbe_block[(((signed long long )10ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%43 = getelementptr inbounds i8* %%x, i64 10, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1166_count);
  llvm_cbe_tmp__344 = ( char *)(&llvm_cbe_x[(((signed long long )10ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%44 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 11, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1173_count);
  llvm_cbe_tmp__345 = ( char *)(&llvm_cbe_block[(((signed long long )11ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%46 = getelementptr inbounds i8* %%x, i64 11, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1175_count);
  llvm_cbe_tmp__347 = ( char *)(&llvm_cbe_x[(((signed long long )11ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%47 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 12, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1182_count);
  llvm_cbe_tmp__348 = ( char *)(&llvm_cbe_block[(((signed long long )12ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%49 = getelementptr inbounds i8* %%x, i64 12, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1184_count);
  llvm_cbe_tmp__350 = ( char *)(&llvm_cbe_x[(((signed long long )12ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%50 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 13, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1191_count);
  llvm_cbe_tmp__351 = ( char *)(&llvm_cbe_block[(((signed long long )13ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%52 = getelementptr inbounds i8* %%x, i64 13, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1193_count);
  llvm_cbe_tmp__353 = ( char *)(&llvm_cbe_x[(((signed long long )13ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%53 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 14, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1200_count);
  llvm_cbe_tmp__354 = ( char *)(&llvm_cbe_block[(((signed long long )14ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%55 = getelementptr inbounds i8* %%x, i64 14, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1202_count);
  llvm_cbe_tmp__356 = ( char *)(&llvm_cbe_x[(((signed long long )14ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%56 = getelementptr inbounds [16 x i8]* %%block, i64 0, i64 15, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1209_count);
  llvm_cbe_tmp__357 = ( char *)(&llvm_cbe_block[(((signed long long )15ull))
#ifdef AESL_BC_SIM
 % 16
#endif
]);
...
printf("\n  %%58 = getelementptr inbounds i8* %%x, i64 15, !dbg !12 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1211_count);
  llvm_cbe_tmp__359 = ( char *)(&llvm_cbe_x[(((signed long long )15ull))]);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
...
printf("\n  %%59 = load i32* getelementptr inbounds (%%struct.AES256_CTR_DRBG_struct* @DRBG_ctx, i64 0, i32 2), align 4, !dbg !15 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1219_count);
  llvm_cbe_tmp__360 = (unsigned int )*((&DRBG_ctx.field2));
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__360);
if (AESL_DEBUG_TRACE)
printf("\n  %%60 = add nsw i32 %%59, 1, !dbg !15 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1220_count);
  llvm_cbe_tmp__361 = (unsigned int )((unsigned int )(llvm_cbe_tmp__360&4294967295ull)) + ((unsigned int )(1u&4294967295ull));
if (AESL_DEBUG_TRACE)
...
printf("\n  store i32 %%60, i32* getelementptr inbounds (%%struct.AES256_CTR_DRBG_struct* @DRBG_ctx, i64 0, i32 2), align 4, !dbg !15 for 0x%I64xth hint within @randombytes_sign  --> \n", ++aesl_llvm_cbe_1221_count);
  *((&DRBG_ctx.field2)) = llvm_cbe_tmp__361;
if (AESL_DEBUG_TRACE)
printf("\n = 0x%X\n", llvm_cbe_tmp__361);
  if (AESL_DEBUG_TRACE)
