...
// ==============================================================
# 1 "C:/Users/ajaiswal/Downloads/project13-master/aes.c"
# 1 "C:/Users/ajaiswal/Downloads/project13-master/aes.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/ajaiswal/Downloads/project13-master/aes.c" 2
# 38 "C:/Users/ajaiswal/Downloads/project13-master/aes.c"
...
# 39 "C:/Users/ajaiswal/Downloads/project13-master/aes.c" 2
...
# 40 "C:/Users/ajaiswal/Downloads/project13-master/aes.c" 2
# 1 "C:/Users/ajaiswal/Downloads/project13-master/aes.h" 1
# 43 "C:/Users/ajaiswal/Downloads/project13-master/aes.h"
struct AES_ctx
{
...
# 74 "C:/Users/ajaiswal/Downloads/project13-master/aes.h"
void AES_CBC_encrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, uint32_t length);
void AES_CBC_decrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, uint32_t length);
# 87 "C:/Users/ajaiswal/Downloads/project13-master/aes.h"
void AES_CTR_xcrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, uint32_t length);
# 41 "C:/Users/ajaiswal/Downloads/project13-master/aes.c" 2
# 80 "C:/Users/ajaiswal/Downloads/project13-master/aes.c"
...
# 152 "C:/Users/ajaiswal/Downloads/project13-master/aes.c"
static void KeyExpansion(uint8_t* RoundKey, const uint8_t* Key)
{
 ...
 KeyExpansion_label0:for (i = 0; i < 8; ++i)
  {
  ...
  KeyExpansion_label1:for (i = 8; i < 4 * (14 + 1); ++i)
  {
    {
      k = (i - 1) * 4;
...
{
  uint8_t i, j;
  SubBytes_label2:for (i = 0; i < 4; ++i)
  {
    for (j = 0; j < 4; ++j)
    {
      SubBytes_label3:(*state)[j][i] = (sbox[((*state)[j][i])]);
    }
  }
}
...
# 348 "C:/Users/ajaiswal/Downloads/project13-master/aes.c"
...
static void Cipher(state_t* state, uint8_t RoundKey[240])
{
  ...
  Cipher_label6:for (round = 1; round < 14; ++round)
  {
    SubBytes(state);
    ShiftRows(state);
    MixColumns(state);
...
static void InvCipher(state_t* state,uint8_t* RoundKey)
{
  ...
  InvCipher_label7:for (round = (14 - 1); round > 0; --round)
  {
    InvShiftRows(state);
    InvSubBytes(state);
    AddRoundKey(round, state, RoundKey);
...
# 469 "C:/Users/ajaiswal/Downloads/project13-master/aes.c"
void AES_ECB_encrypt(struct AES_ctx *ctx, state_t* buf)
{
...
# 492 "C:/Users/ajaiswal/Downloads/project13-master/aes.c"
static void XorWithIv(uint8_t* buf, uint8_t* Iv)
{
  uint8_t i;
  XorWithIv_label8:for (i = 0; i < 16; ++i)
  {
    buf[i] ^= Iv[i];
  }
}
...
void AES_CBC_encrypt_buffer(struct AES_ctx *ctx,uint8_t* buf, uint32_t length)
{
  uintptr_t i;
  uint8_t *Iv = ctx->Iv;
  AES_CBC_encrypt_buffer_label9:for (i = 0; i < length; i += 16)
  {
    XorWithIv(buf, Iv);
...
void AES_CBC_decrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, uint32_t length)
{
  ...
  AES_CBC_decrypt_buffer_label10:for (i = 0; i < length; i += 16)
  {
...
# 539 "C:/Users/ajaiswal/Downloads/project13-master/aes.c"
void AES_CTR_xcrypt_buffer(struct AES_ctx* ctx, uint8_t* buf, uint32_t length)
{
  uint8_t buffer[16];
  ...
  unsigned i;
  int bi;
  AES_CTR_xcrypt_buffer_label11:for (i = 0, bi = 16; i < length; ++i, ++bi)
  {
    if (bi == 16)
    {
