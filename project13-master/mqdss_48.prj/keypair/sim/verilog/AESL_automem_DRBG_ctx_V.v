...
module AESL_automem_DRBG_ctx_V (
    clk,
    rst,
    ce0,
    we0,
...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.crypto_sign_keypair.autotvin_DRBG_ctx_V.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.crypto_sign_keypair.autotvout_DRBG_ctx_V.dat"; 
//------------------------Local signal-------------------
