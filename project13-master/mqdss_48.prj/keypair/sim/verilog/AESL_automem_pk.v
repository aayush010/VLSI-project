...
//------------------------Parameter----------------------
localparam
    TV_IN  = "../tv/cdatafile/c.crypto_sign_keypair.autotvin_pk.dat", 
    TV_OUT = "../tv/rtldatafile/rtl.crypto_sign_keypair.autotvout_pk.dat"; 
//------------------------Local signal-------------------
parameter DATA_WIDTH = 32'd 8;
parameter ADDR_WIDTH = 32'd 6;
parameter DEPTH = 32'd 46;
parameter DLY = 0.1;
