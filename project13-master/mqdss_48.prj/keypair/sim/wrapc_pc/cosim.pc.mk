...
$(ObjDir)/gf31.c_pre.c.tb.o : gf31.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) gf31.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/mq.c_pre.c.tb.o : mq.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) mq.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
